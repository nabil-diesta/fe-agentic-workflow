...
export const routes: Routes = [
  { path: '', redirectTo: 'sprint', pathMatch: 'full' },
  {
    ...
    children: [
      ...
      { path: 'pipeline/:taskId', loadComponent: () => import('./features/pipeline/pipeline-view.component').then((m) => m.PipelineViewComponent) },
      { path: 'pipelines', loadComponent: () => import('./features/pipelines/pipelines.component').then((m) => m.PipelinesComponent) },
